...
import { GetSuccess, GetEditForm } from './../../../reducers/action/notification';
...
const Users = () => {
    ...
    const editQuote = (e, quote) => {
        ...
        let showText = <div id="modal-message"><h3>Under Construction!</h3><p>Message: </p><textarea id="modal-textarea" placeholder={quote.message} /></div>
    ...
    const removeQuote = (e, person) => {
        ...
        let message = "This is getting deleted: " + JSON.stringify(person.name.first);
        GetSuccess(message)
